...
export default function HexRgb() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-white mb-2">HEX ↔ RGB Converter</h1>
        <p className="text-gray-400 text-sm">Convert between HEX color codes and RGB values in real time.</p>
      </div>
      ...
      <div className="card p-5 mt-6">
        <h2 className="font-semibold text-white mb-4">All Values</h2>
      ...
      <div className="mt-8 p-5 card text-sm text-gray-400 leading-relaxed">
        <h3 className="text-white font-semibold mb-2">About HEX & RGB</h3>
        <p>HEX color codes (e.g. <code className="text-violet-400">#7c3aed</code>) are widely used in CSS and design tools. Each pair of hex digits represents a Red, Green, or Blue channel value from 0 (00) to 255 (FF).</p>
        <p className="mt-2">RGB notation (e.g. <code className="text-violet-400">rgb(124, 58, 237)</code>) uses decimal integers from 0–255 for the same three channels, which can be easier to read and manipulate programmatically.</p>
      </div>
    </div>
  );
}
